...
public class WriterProtobufTest {
    ...
    public void testWriterProtobufWriteTag() throws Exception {
        ...
        assertArrayEquals(new byte[]{testByte}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteByte() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0xFF}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteVarIntUnder8Bits() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x0C}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteVarIntUnder15Bits() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x8C, (byte) 0x04}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteVarInt64Bits() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x84, (byte) 0x80, (byte) 0x81, (byte) 0x88, (byte) 0x80, (byte) 0x84, (byte) 0x80, (byte) 0x88, (byte) 0x28}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteBool() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x01}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteFloat32() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x0A, (byte) 0xD7, (byte) 0x43, (byte) 0x41}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteFloat64() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x7B, (byte) 0x14, (byte) 0xAE, (byte) 0x47, (byte) 0xE1, (byte) 0x7A, (byte) 0x28, (byte) 0x40}, writerProtobuf.toBuffer());
    }
    ...
    public void testWriterProtobufWriteString() throws Exception {
        ...
        assertArrayEquals(new byte[]{(byte) 0x06, (byte) 0x68, (byte) 0xC4, (byte) 0xA1, (byte) 0xE2, (byte) 0x88, (byte) 0x9A}, writerProtobuf.toBuffer());
    }
